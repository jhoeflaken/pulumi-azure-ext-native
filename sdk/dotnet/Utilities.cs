...
namespace Pulumi.AzureExt
{
    static class Utilities
    {
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AzureExt.version.txt");
    ...
    internal sealed class AzureExtResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AzureExtResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
